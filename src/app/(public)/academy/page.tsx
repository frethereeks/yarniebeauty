...
// Updated Metadata with complete OG and Twitter fields
export const metadata: Metadata = {
  title: "Academy — Yarniebeauty",
  description: "Learn to crochet properly with small cohorts, real feedback, and the professional techniques behind every piece in our shop. Join our online or in-person crochet academy.",
  metadataBase: new URL(process.env.NEXTAUTH_URL as string),
  openGraph: {
    title: "Academy — Yarniebeauty",
    description: "Learn to crochet properly with small cohorts, real feedback, and the professional techniques behind every piece in our shop. Join our online or in-person crochet academy.",
    url: `${process.env.NEXTAUTH_URL}/academy`,
    siteName: "Yarniebeauty — Handcrafted Yarn & Crochet",
    type: "website",
    images: [
      {
        url: "/brand/logo-old.jpg", // Replace with a specific academy banner image if you have one later
        width: 1200,
        height: 630,
        alt: "Yarniebeauty Academy — Learn to crochet, properly.",
      },
    ],
    locale: "en_US",
  },
  twitter: {
    ...
    title: "Academy — Yarniebeauty",
    description: "Learn to crochet properly with small cohorts, real feedback, and the professional techniques behind every piece in our shop.",
    images: ["/brand/logo-old.jpg"],
  },
};
